  ...
  meta: {
    business: {
      ...
      description: {
        ...
        description2: "Profil Decor este sursa ta principala de profile decorative inovative, ce aduc un plus de rafinament si stil exteriorului locuintei tale.",
      ...
      reason: {
        ...
        reason4: "Si pentru că stim că decorarea/renovarea fatadei poate implica multe costuri am introdus pentru tine plata in rate fixe fara dobanda pentru ca tu să te bucuri de tot ceea ce îti doresti!",
      }
    }
  },
  navigationMenu: {
